<template>
  <div>
    ...
    <form @submit.prevent="updateStudent">
      ...
      <br>
      <br>Zip:
      <input v-model="student.zip" type="text" id="zip" v-on:blur="cityStateLookup()">
      ...
      <input
        ...
        value="FR"
      >Freshman
      <input v-model="student.classification" type="radio" name="classification" value="SO">Sophmore
      <input v-model="student.classification" type="radio" name="classification" value="JR">Junior
      <input v-model="student.classification" type="radio" name="classification" value="SR">Senior
      <span id="classificationErr" class="error">{{ errors.classification || '*' }}</span>
      <br>
      <br>Gender:
      <input v-model="student.gender" type="radio" name="gender" value="F">Female
